 ...
 * CREATED     : 14-JUN-2013
 * LASTUPDATES : $Author: patrickw $ on $Date: 2013-04-23 18:08:56 +0800 (Tue, 23 Apr 2013) $
 * UPDATES     :
 * NOTES       :
 */
/* ---------------------------------------------------------------
   @(#) ClassAutoloader.php     1.0 14-JUN-2013
   by Michelle Hong
...
class ClassAutoloader {
     ...
     * @version 1.0
     * @since  Version 1.0
     * @param array $namespaces         an array of the key value pair for
                                        namespace and its path
     * @return boolean | this ClassAutoloader
     * @see
     * @author          Michelle Hong
     * @testing
     * @warnings
    ...
    protected function transformClassNameToFilename($class, $directory) {
        ...
        $matches = array();
        preg_match(
            '/(?P<namespace>.+\\\)?(?P<class>[^\\\]+$)/', $class, $matches
        );
