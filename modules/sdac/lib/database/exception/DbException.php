 ...
 * SYNOPSIS    :
 * DESCRIPTION : Clms Database Exception
 * SEE ALSO    :
 * VERSION     : 1.0 ($Revision: 88 $)
 * CREATED     : Jan 8, 2013
 * LASTUPDATES : $Author: michellehong $ on $Date: 2016-05-24 11:12:45 +0800 (週二, 24 五月 2016) $
 * UPDATES     :
 * NOTES       :
 */
/* ---------------------------------------------------------------
...
namespace Clms\Tools\PhpDao\Exception;
/* ---------------------------------------------------------------
   Included Library
   --------------------------------------------------------------- */
...
class DbException extends \Exception
{
    ...
    /**
     * Error code for invalid search parameters
     * @var integer
     * @since  Version 1.4
     * @author      Michelle Hong
     * @updates
     */
    const DBERROR_INVALID_PARAMETER= 100012;
    
    /**
     * Error code for duplicate keys
     * @var integer
     * @since  Version 1.4
     * @author      Michelle Hong
     * @updates
     */
    const DBERROR_DUPLICATE_KEY= 100013;
    
    /**
     * Error code for create index failed
     * @var integer
     * @since  Version 1.4
     * @author      Michelle Hong
     * @updates
     */
    const DBERROR_CANNOT_CREATE_INDEX = 100014;
    ...
    private function getErrorMessage($code)
    {
        switch ($code) {
            ...
            case self::DBERROR_INVALID_PARAMETER :
                return 'Invalid Parameters';
            case self::DBERROR_DUPLICATE_KEY :
                return 'Duplicate key error';
            case self::DBERROR_CANNOT_CREATE_INDEX:
